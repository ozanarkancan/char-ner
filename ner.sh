...
THEANO_FLAGS=blas.ldflags="-L/mnt/kufs/scratch/ocan13/opt/OpenBLAS/lib -lopenblas",mode=FAST_RUN,device=gpu,floatX=float32,nvcc.flags=-arch=sm_30,scan.allow_gc=False python src/exper.py --activation bi-relu bi-relu --n_hidden 400 400 --drates 0.5 0.5 0.5 --n_batch 32 --recout 2 --opt adam --norm 1 --fepoch 500
